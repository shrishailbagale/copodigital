                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                <div class="card-body">
                                    <span style="font-size:26px;"> <?php echo $totalusers;?></span>
                                    <h6>Total Clients</h6>
                            ...
                            <div class="card bg-warning text-dark mb-4">
                                <div class="card-body">
                                    <span style="font-size:26px;">
                                        <?php echo $yesterdayregusers;?></span>
                                    <h6>Yesterday Contact</h6>

                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="yesterday-reg-users.php">Contact
                                        Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-success text-white mb-4">
                                <div class="card-body">
                                    <span style="font-size:26px;">
                                        <?php echo $last7daysregusers;?></span>
                                    <h6>Contacted in Last 7 Days</h6>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
